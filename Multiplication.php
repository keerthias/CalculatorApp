        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="index.php">ADDITION</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="Subtraction.php">SUBTRACTION</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="Multiplication.php">MULTIPLICATION</a>
                </li>
        ...
        <div class="row">
          ...
          <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <table class="table">
              ...
              <tr>
                <td></td>
                <td><button onclick="mycalculator()" class="btn btn-success">PRODUCT</button></td>
              </tr>
              <tr>
                <td>RESULT</td>
                <td><P id="res"></P></td>
